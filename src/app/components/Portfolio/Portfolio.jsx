...
const ProjectCard = ({ id, name, image, description }) => {
    return (
        <div className={`${styles.card} relative flex flex-col justify-between w-80 h-[350px] rounded-xl bg-white bg-clip-border text-gray-700 shadow-md group`}>
            <div className='w-full h-56 overflow-hidden bg-primary rounded-xl'>
